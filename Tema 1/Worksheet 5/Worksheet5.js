/*Ejercicio. 1 Crea	un	script	que	pregunte	tu	nombre,	apellidos	y	tu	edad	y	los	muestre	en	la	página	web	en
párrafos	distintos
...
/*Ejercicio. 2 - Crea	un	script	que	muestre	en	una	ventana	emergente	“hola”	y	tu	nombre	(pidiéndolo
...
/*Ejercicio. 3 Crea	un	script	que	pida	al	usuario	su	edad,	nombre,	apellidos	y	ciclo	que	estudia,	y	muestre	esa
...
/*Ejercicio. 4 Crea	un	script	que	determine	si	un	número	introducido	por	el	usuario	es	par
...
/*Ejercicio. 5 Crea	un	script	que	reciba	la	edad	de	un	usuario	y	determine	si	es	mayor	de	edad.
...
/*Ejercicio. 6 Crea	un	script	que	reciba	la	edad	de	un	usuario,	y	su	localidad	de	nacimiento	y	muestre	en	pantalla
...
/*Ejercicio. 7 Crea	un	script	que	pida	un	número	al	usuario,	y	si	ese	número	es	superior	a	100	le	aplique	un
...
*/
/*Ejercicio. 8 Crea	un	script	que	pregunte	al	usuario	por	su	nombre,	y	conteste	“Bienvenido”	o	“Bienvenida”	según
...
/*Ejercicio. 9 Crea	un	script	que	pida	a	un	usuario	dónde	vive;	si	vive	en	Madrid	y	tiene	entre	18	y	30 años,	el	script
...
/*Ejercicio. 10 Crea	un	script	que	pida	al	usuario	su	nombre	y	apellidos.	Si	el	nombre	es	“Ricardo”,	debe	mostrar	en
...
/*Ejercicio. 11 Crea	un	script	que	reciba	la	edad	de	un	usuario	y	determine	si	puede	jubilarse	o	no	(la	jubilación	se
alcanza	con	67 años).
var num = prompt("Intoduce la edad");
if(num >66){
...
/*Ejercicio. 12 Crea	un	script	que	pregunte	la	edad,	y	determine	si	debes	estar	en	el	jardín	de	infancia	(menores	de
...
/*Ejercicio. 13 Crea	un	script	que	pregunte	al	usuario	el	número	de	hermanos	que	tiene	y	una	cantidad.	En	el	caso
...
/*Ejercicio. 14 Crea	un	script	que	recoja	la	nota	de	dos	exámenes	y	dos	trabajos	y	determine	si	la	media	es	superior
...
/*Ejercicio. 15 Crea	un	script	que	pregunte	al	usuario	por	el	nombre	de	un	mes,	y	muestre	el	número	de	días	que
tiene	el	mes.
...
/*Ejercicio. 16 Crea	un	script	que	pregunte	al	usuario	por	un	número,	y	determine	si	es	par,	si	es	múltiplo	de	tres,	y
si	es	múltiplo	de	5. */
...
/*Ejercicio. 17 Crea	un	script	que	pida	al	usuario	dos	números	y	una	operación	(que	puede	ser	el	carácter	+,	-,	*	o	/).
...
/*Ejercicio. 18 Crea	un	script	que	muestre	en	la	página	web	todos	los	números	desde	el	uno	hasta	el	10,	cada	uno
...
/*Ejercicio. 19 Crea	un	script	que	pida	al	usuario	un	número,	e	imprima	en	el	documento	HTML	todos	los	números
...
/*Ejercicio. 20 Crea	un	script	que	pregunte	constantemente	números	al	usuario	hasta	que	el	usuario	introduzca	el
número	0.
let num=1;
do{
...
/*Ejercicio. 21 Crea	que	un	script	que	imprima	en	el	documento	HTML	todas	las	palabras	introducidas	por	el	usuario.
...
/*Ejercicio. 22 Crea	un	script	que	pida	al	usuario	10	números,	y	muestre	su	suma	en	pantalla.
var contador=0;
var numtotal=0;
do{
