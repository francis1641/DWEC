...
document.write(inviertePalabras("hellow","Bye","Seamos"));
*/
...
encuentraPalabraMasLarga("Albornoz","Teclado","Jaja","Esternocleidomastoideo");
*/
...
filtraPalabraMasLarga(4,"ojala","antonio","cara");
*/
...
cadenaBienFormada("pedro","fermin","francis","pepe");
*/


/*Ejercicio 2. Definir una funcion que muestre informacion sobre una cadena de texto que se
...
informacioncadena("Antonia y pepita en realidad son manola");
*/
